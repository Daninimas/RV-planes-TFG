...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class XRGrabInteractableExtended : XRBaseInteractable
    {
        ...
        /// <summary>
        /// When this object is picked, it detaches from the parent. The usual behaviour is on true
        /// </summary>
        public bool detachFromParentWhenPicked = true;
